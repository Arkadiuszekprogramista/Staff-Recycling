"""
Django settings for PortfoliLab project.
...
SECRET_KEY = 'django-insecure-r01mj9^i(9eluewo2vuznf%8)t8gwyp$aok4n9l#lw)jfbio(2'
...
WSGI_APPLICATION = 'PortfoliLab.wsgi.application'
